...
// Insérer le message
$stmt = $conn->prepare("INSERT INTO messages (conversation_id, expediteur_id, expediteur_type, destinataire_id, destinataire_type, contenu, date_envoi, lu) VALUES (?, ?, 'marche', ?, ?, ?, NOW(), 0)");
$ok = $stmt->execute([$conversation_id, $marche_id, $dest_id, $dest_type, $message]);
