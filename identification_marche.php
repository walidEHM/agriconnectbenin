    ...
    <head>
        ...
        <title>AgriConnect BENIN - Espace Marchés</title>
    ...
    <body>
        <div class="left-section">
            <div class="left-content" id="leftContent">
                ...
                <h2 id="leftTitle">Connectez-vous aux meilleurs producteurs du Bénin</h2>
                <p id="leftText">Accédez à un réseau d'agriculteurs locaux de confiance, gérez vos approvisionnements et
                    développez votre activité commerciale avec notre plateforme dédiée aux marchés et acheteurs.</p>
                ...
                <div class="features">
                    <div class="feature-item">
                        ...
                        <span>Trouvez des producteurs par culture et localisation</span>
                    </div>
                    <div class="feature-item">
                        <div class="feature-icon">
                            <i class="fas fa-comments"></i>
                        </div>
                        <span>Contactez directement les agriculteurs</span>
                    </div>
                    <div class="feature-item">
                        <div class="feature-icon">
                            <i class="fas fa-file-contract"></i>
                        </div>
                        <span>Accédez aux documents et certifications</span>
                    </div>
                </div>
            ...
            <div class="form-container">
                ...
                <div class="register-form" id="registerForm">
                    <div class="form-header">
                        <h2>Créer un compte Marché</h2>
                        <p>Rejoignez notre réseau et accédez à des producteurs de qualité</p>
                    </div>

                    <form id="registrationForm" action="data/traitement_inscription_marche.php" method="post"
                        enctype="multipart/form-data">
                        <div class="form-group">
                            <label for="nom_marche" class="form-label">Nom d'utilisateur</label>
                            <input type="text" id="nom_marche" name="nom_marche" class="form-input" required>
                            <div id="nom_marche-error" class="error-message">Veuillez entrer le nom de votre marché
                            </div>
                        </div>
                        ...
                        <div class="checkbox-container">
                            ...
                            <label for="terms">J'accepte les <a href="conditions_utilisation.php"
                                    target="_blank">conditions
                                    d'utilisation</a> d'AgriConnect BENIN</label>
                        </div>
                ...
                <div class="login-form" id="loginForm">
                    <div class="form-header">
                        ...
                        <p>Accédez à votre espace marché</p>
                    </div>

                    <form action="data/traitement_connexion_marche.php" method="post">
                        <div class="form-group">
                        ...
                        <div class="form-group" style="text-align: right;">
                            <a href="#" id="lien_mot_de_passe_oublie_marche"
        ...
        <div class="modale_mot_de_passe_oublie_marche" id="modale_mot_de_passe_oublie_marche">
            <div class="conteneur_modale_mot_de_passe_oublie_marche">
                <div class="entete_modale_mot_de_passe_oublie_marche">
                    <h2>Réinitialiser votre mot de passe</h2>
                    <button class="bouton_fermeture_modale_mot_de_passe_oublie_marche"
                        id="bouton_fermeture_modale_mot_de_passe_oublie_marche">&times;</button>
                </div>

                <div class="corps_modale_mot_de_passe_oublie_marche">
                    <p class="description_modale_mot_de_passe_oublie_marche">Entrez votre adresse email
                        pour recevoir un lien de réinitialisation</p>

                    <form id="formulaire_mot_de_passe_oublie_marche" method="post"
                        action="data/traitement_mot_de_passe_oublie_marche.php" enctype="multipart/form-data">
                        <div class="form-group">
                            <label for="email_mot_de_passe_oublie_marche" class="form-label">Adresse
                                email</label>
                            <div class="input-container">
                                <input type="email" id="email_mot_de_passe_oublie_marche" name="email"
                                    class="form-input" placeholder="exemple@email.com" required>
                                <i class="fas fa-envelope input-icon"></i>
                            </div>
                            <div id="erreur_email_mot_de_passe_oublie_marche"
                                class="message_erreur_mot_de_passe_oublie_marche">Veuillez entrer une
                ...
                <div class="pied_modale_mot_de_passe_oublie_marche">
                    <a href="#" id="lien_retour_connexion_mot_de_passe_oublie_marche">Retour à la
                        connexion</a>
                </div>
            </div>
        </div>
    ...
    const DOM = {
        ...
        nomMarche: document.getElementById('nom_marche'),
        ...
        // Messages d'erreur
        nomMarcheError: document.getElementById('nom_marche-error'),
        ...
        // Modale mot de passe oublié
        modaleMotDePasseOublie: document.getElementById('modale_mot_de_passe_oublie_marche'),
        lienMotDePasseOublie: document.getElementById('lien_mot_de_passe_oublie_marche'),
        boutonFermetureModale: document.getElementById('bouton_fermeture_modale_mot_de_passe_oublie_marche'),
        formulaireMotDePasseOublie: document.getElementById('formulaire_mot_de_passe_oublie_marche')
    };
    ...
    const formManager = {
        ...
        setupValidation: function() {
            ...
            if (DOM.registrationForm) {
                ...
                // Validation en temps réel
                if (DOM.nomMarche) {
                    DOM.nomMarche.addEventListener('input', () => {
                        utils.toggleError(DOM.nomMarche, false, DOM.nomMarcheError);
                    });
                }
        ...
        validateRegistrationForm: function() {
            ...
            if (DOM.nomMarche && DOM.nomMarche.value.trim() === '') {
                utils.toggleError(DOM.nomMarche, true, DOM.nomMarcheError);
                isValid = false;
            }
    ...
    const modalManager = {
        ...
        openModal: function() {
            ...
            setTimeout(() => {
                ...
                const emailInput = document.getElementById('email_mot_de_passe_oublie_marche');
        ...
        handlePasswordReset: async function(e) {
            ...
            const errorElement = document.getElementById('erreur_email_mot_de_passe_oublie_marche');
            ...
            try {
                ...
                if (data.success) {
                    setTimeout(() => {
                        window.location.href = 'verifier_code_de_mot_de_passe_oublie_marche.php?email=' + 
