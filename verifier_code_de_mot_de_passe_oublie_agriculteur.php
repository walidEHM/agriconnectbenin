...
$sql = 'SELECT token_verification, expiration_token FROM agriculteurs 
    ...
    echo '<div class="container">
        ...
        <div class="card">
            <div class="notification notification-error">
                ...
                <a href="data/renvoyer_code_agriculteur.php?email='.urlencode(htmlspecialchars($email)).'" class="link">demander un nouveau code</a>.
            </div>
        </div>
        <div class="text-center">
            <a href="identification_agriculteur.php#showLoginForm" class="link">Retour à la page de connexion</a>
        </div>
    </div>';
exit();
}
...
<body>
    <div class="container">
        ...
        <div class="card">
            ...
            <form action="data/traitement_verification_code_agriculteur.php" method="POST">
            ...
            <div style="margin-top: 20px; text-align: center;">
                <p>Vous n'avez pas reçu de code ?
                    <a href="data/renvoyer_code_agriculteur.php?email=<?php echo urlencode($email); ?>"
                        class="link">Renvoyer
                        le code</a>
                </p>
            </div>
    ...
    document.addEventListener('DOMContentLoaded', function() {
        ...
        const resendLink = document.querySelector('a[href*="renvoyer_code_agriculteur.php"]');
